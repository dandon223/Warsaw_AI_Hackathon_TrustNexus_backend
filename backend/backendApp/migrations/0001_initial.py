...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'unique_together': {('encrypted_sender_name', 'encrypted_sender_email', 'encrypted_recipient_name', 'encrypted_recipient_email', 'encrypted_subject', 'encrypted_date', 'encrypted_message_content')},
            },
        ),
    ]
